...
CREATE TABLE media_manual_review_import (
...
CREATE TABLE media_canonical_move_manifest (
    ...
    current_staging_path TEXT NOT NULL,
    ...
    move_required INTEGER NOT NULL DEFAULT 1,
    rename_required INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE media_physical_cleanup_manifest (
    cleanup_id INTEGER PRIMARY KEY AUTOINCREMENT,
    inventory_id INTEGER NOT NULL,
    sha256 TEXT NOT NULL,
    keep_path TEXT NOT NULL,
    remove_path TEXT NOT NULL,
    status TEXT NOT NULL DEFAULT 'PLANNED'
        CHECK(status IN ('PLANNED','VERIFIED','DELETED','FAILED','SKIPPED')),
    error_message TEXT,
    created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP
);
